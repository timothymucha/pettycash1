...
def build_alias_map(vendors: list[str]) -> dict[str, str]:
    ...
    manual = {
        ...
        "cigarattes": "Benchmark Distributors Limited",
        "cigarrattes": "Benchmark Distributors Limited",
        "takataka": "Takataka",
...
def classify_and_rows(row, seq, threshold):
    ...
    if "transaction cost" in details_n:
        ...
        return [
            ...
            ["SPL",  "CHECK", date_str, "Bank Service Charges:Bank Charges - Mpesa", "Mpesa",  amt, memo_bank, docnum, clear],
        ]
